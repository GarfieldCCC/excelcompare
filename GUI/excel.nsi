...
; 许可协议页面
!insertmacro MUI_PAGE_LICENSE "D:\Useful\NSIS\LICENSE.TXT"
; 安装目录选择页面
...
OutFile "Setup.exe"
InstallDir "$PROGRAMFILES\Excel差异对比"
InstallDirRegKey HKLM "${PRODUCT_UNINST_KEY}" "UninstallString"
ShowInstDetails show
ShowUnInstDetails show
BrandingText "Garfield"
...
Section -AdditionalIcons
  CreateShortCut "$SMPROGRAMS\Excel差异对比\Uninstall.lnk" "$INSTDIR\uninst.exe"
SectionEnd
...
Section Uninstall
  ...
  Delete "$SMPROGRAMS\Excel差异对比\Excel差异对比.lnk"

  RMDir "$SMPROGRAMS\Excel差异对比"
