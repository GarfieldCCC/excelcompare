...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "陕鼓汇总表EXCEL差异对比专用"))
        ...
        self.label.setText(_translate("MainWindow",
                                      "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600; color:#000000;\">点击第一个按钮选择旧版，点击第二个按钮选择新版</span></p><p><span style=\" font-size:12pt; font-weight:600; color:#000000;\">本软件将基于旧版文件进行比较</span></p></body></html>"))
        self.pushButton.setText(_translate("MainWindow", "选择旧版本汇总表\nexcel文件"))
        self.pushButton_2.setText(_translate("MainWindow", "选择新版本汇总表\nexcel文件"))
        self.pushButton_3.setText(_translate("MainWindow", "汇总表excel\n对比结果导出"))
